    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Ready to Discover Your <span className="text-yellow-300 relative inline-block">
              Perfect
              <Sparkles className="absolute -top-4 -right-4 w-5 h-5 text-yellow-300 animate-pulse" />
            </span> University Match?
          </motion.h2>
          ...
          >
            Join <span className="font-semibold text-white">10,000+ students</span> who found their ideal courses with our AI-powered matching system.
          </motion.p>
          ...
          >
            <div className="flex items-center">
              <svg className="w-4 h-4 mr-2 text-yellow-300 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              No credit card required
            </div>
            <div className="h-1 w-1 bg-indigo-300 rounded-full" aria-hidden="true"></div>
            <div className="flex items-center">
              <svg className="w-4 h-4 mr-2 text-yellow-300 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
